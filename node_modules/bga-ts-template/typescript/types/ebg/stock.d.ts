...
declare class Stock {
	...
	*/
	...
	static extend: dojo._base.DeclareConstructor<Stock>['extend'];
	/** See definition from {@link dojo._base.DeclareConstructor.createSubclass} for more information. */
	static createSubclass: dojo._base.DeclareConstructor<Stock>['createSubclass'];
}

interface Stock extends dojo._base.DeclareCreatedObject {}

declare global {
	interface EBG { stock: typeof Stock; }
