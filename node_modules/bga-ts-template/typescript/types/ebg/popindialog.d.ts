...
declare class PopInDialog
{
	...
	static extend: dojo._base.DeclareConstructor<PopInDialog>['extend'];
	/** See definition from {@link dojo._base.DeclareConstructor.createSubclass} for more information. */
	static createSubclass: dojo._base.DeclareConstructor<PopInDialog>['createSubclass'];
}

interface PopInDialog extends dojo._base.DeclareCreatedObject {}

declare global {
	interface EBG { popindialog: typeof PopInDialog; }
