...
import Gamegui = require("ebg/core/gamegui"); // Type dependency, not runtime dependency
...
declare class GameNotif {
	...
	queue: [];
	/** Internal. The reference to the game that manages this. Usually this is for validation, filtering (like players), or checking if the game is in {@link CoreCore.instantaneousMode}. */
	game: Gamegui;
	...
	static extend: dojo._base.DeclareConstructor<GameNotif>['extend'];
	/** See definition from {@link dojo._base.DeclareConstructor.createSubclass} for more information. */
	static createSubclass: dojo._base.DeclareConstructor<GameNotif>['createSubclass'];
}

interface GameNotif extends dojo._base.DeclareCreatedObject {}

declare global {
	interface EBG { gamenotif: typeof GameNotif; }
