...
declare class Counter {
	...
	static extend: dojo._base.DeclareConstructor<Counter>['extend'];
	/** See definition from {@link dojo._base.DeclareConstructor.createSubclass} for more information. */
	static createSubclass: dojo._base.DeclareConstructor<Counter>['createSubclass'];
}

interface Counter extends dojo._base.DeclareCreatedObject {}

declare global {
	interface EBG { counter: typeof Counter; }
