...
declare class ScrollMap
{
	...
	*/
	...
	static createSubclass: dojo._base.DeclareConstructor<ScrollMap>['createSubclass'];
}

interface ScrollMap extends dojo._base.DeclareCreatedObject {}

declare global {
	interface EBG { scrollmap: typeof ScrollMap; }
