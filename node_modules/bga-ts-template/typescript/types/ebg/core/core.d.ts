...
import WebRTC = require("ebg/webrtc");
import WebPush = require("ebg/webpush");
...
declare class CoreCore {
	...
	*/
	...
	static extend: dojo._base.DeclareConstructor<CoreCore>['extend'];
	/** See definition from {@link dojo._base.DeclareConstructor.createSubclass} for more information. */
	static createSubclass: dojo._base.DeclareConstructor<CoreCore>['createSubclass'];
}

interface CoreCore extends dojo._base.DeclareCreatedObject {}

declare global {
	interface EBG_CORE { core: typeof CoreCore; }
