 ...
 * GomokuFlutes implementation : © Flutes flutegirl@gmail.com
 *
 * This code has been produced on the BGA studio platform for use on http://boardgamearena.com.
 * See http://en.boardgamearena.com/#!doc/Studio for more information.
 * -----
 */
/// <amd-module name="bgagame/gomokuflutes"/>

import Gamegui = require('ebg/core/gamegui');
import "ebg/counter";

/** The root for all of your game code. */
class GomokuFlutes extends Gamegui
{
...
// The global 'bgagame.gomokuflutes' class is instantiated when the page is loaded. The following code sets this variable to your game class.
dojo.setObject( "bgagame.gomokuflutes", GomokuFlutes );
// Same as: (window.bgagame ??= {}).gomokuflutes = GomokuFlutes;